...
function show_stats() {
    ...
    outer_button_cont.style.marginBottom = '2.5rem'

    let inner_button_cont1 = document.createElement("div")
    inner_button_cont1.className = 'cont'
    inner_button_cont1.style.width = '33%'

    let button1 = document.createElement("button")
    button1.className = 'rounds'
    button1.value = '5'
    button1.innerText = '5'
    ...
    inner_button_cont2.className = 'cont'
    inner_button_cont2.style.width = '33%'

    let button2 = document.createElement("button")
    button2.className = 'rounds'
    button2.value = '20'
    ...
    inner_button_cont3.className = 'cont'
    inner_button_cont3.style.width = '33%'

    let button3 = document.createElement("button")
    button3.className = 'rounds'
    button3.value = '50'
